...
export default function HomePage() {
  ...
  const loading = catLoading || hotLoading || pickLoading;
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-[1600px] mx-auto lg:px-5 py-3 grid grid-cols-1 lg:grid-cols-[220px_1fr] gap-3">
        ...
        {/* Main content */}
        <main className="space-y-3 lg:space-y-8">
          {/* ===== Banner + Promo ===== */}
          <div className="w-full">
            <div className="hidden lg:grid lg:grid-cols-[1fr_220px] gap-2">
              <div>
                <HeroBannerClient limit={6} heightClass="aspect-[3/1] w-full" />
              </div>
              <div className="flex flex-col gap-2 h-full">
                <PromoCard index={0} className="flex-1" />
                <PromoCard index={1} className="flex-1" />
              </div>
            </div>
          ...
          {/* ===== New Arrivals Section (infinite scroll) ===== */}
          <ErrorBoundary>
            <NewArrivalsSection />
          </ErrorBoundary>
