    ...
    <main className="py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto mt-10" suppressHydrationWarning>
      ...
      {initialLoading && parsedProducts.length === 0 ? (
        ...
        <>
              ...
              return (
                ...
                >
                  ...
                  <div className="w-24 shrink-0">
                    ...
                    <div className="relative aspect-[4/3] w-24 rounded-md overflow-hidden bg-white border">
                      <Link
          ...
          {/* ============================
              DESKTOP GRID: using ProductCard component
             ============================ */}
          <div className="hidden lg:grid lg:grid-cols-4 gap-5">
            {parsedProducts.map((p) => {
              const productData = {
                ...
                image: p.image ?? (Array.isArray(p.images) ? p.images[0] : undefined) ?? FALLBACK_IMG,
                stock: Number(p.stock ?? 0),
              };
              return (
                <div key={p._id}>
                  <ProductCard product={productData} showDiscount={true} />
                </div>
              );
            })}
          </div>
