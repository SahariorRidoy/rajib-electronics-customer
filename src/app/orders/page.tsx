...
export default function MyOrdersPage() {
  ...
  const { orders, isLoading, error, refetch, currentPhone, page, totalPages, setPage } =
    useCustomerOrders();
    ...
    <div className="min-h-screen bg-white py-20 sm:py-8">
      <div className="max-w-6xl mx-auto px-3 sm:px-4 lg:px-6">
        ...
        <div className="text-center mb-3 sm:mb-8">
          ...
          {!isAuthed && (
            <div className="bg-linear-to-r from-cyan-50 to-blue-50 border border-cyan-200 rounded-lg p-2 sm:p-4 max-w-2xl mx-auto mb-2 sm:mb-4">
        ...
        {!isLoading && totalPages > 1 && (
          <div className="flex justify-center items-center gap-2 mt-8">
            <button
              ...
              disabled={page === 1}
              className="px-4 py-2 rounded-lg bg-white border-2 border-[#167389] text-[#167389] disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[#167389] hover:text-white"
            >
              Previous
            </button>
